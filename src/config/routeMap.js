...
const PowerForcast_ShortTermForcast = Loadable({loader: () => import(/*webpackChunkName:'AdminPage'*/'@/views/power-forcast/shortTermForcast'),loading: Loading});
const PowerForcast_MiddleTermForcast = Loadable({loader: () => import(/*webpackChunkName:'AdminPage'*/'@/views/power-forcast/middleTermForcast'),loading: Loading});
const PowerForcast_LongTermForcast = Loadable({loader: () => import(/*webpackChunkName:'AdminPage'*/'@/views/power-forcast/longTermForcast'),loading: Loading});
...
export default [
  ...
  { path: "/power-forcast/short-term-forcast", component: PowerForcast_ShortTermForcast, roles: ["admin","editor","guest"] },
  { path: "/power-forcast/middle-term-forcast", component: PowerForcast_MiddleTermForcast, roles: ["admin","editor","guest"] },
  { path: "/power-forcast/long-term-forcast", component: PowerForcast_LongTermForcast, roles: ["admin","editor","guest"] },
